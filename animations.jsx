  ...
  return (
    ...
    >
      ...
      <PlaybackBar
        ...
        onReset={() => { setTime(0); }}
        onRestart={() => { setTime(0); setPlaying(true); }}
        onSeek={(t) => setTime(t)}
...
function PlaybackBar({ time, duration, playing, onPlayPause, onReset, onRestart, onSeek, onHover }) {
  ...
  return (
    <div data-omelette-chrome style={{
      ...
      {onRestart && (
        <IconButton onClick={onRestart} title="Přehrát od začátku">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M2 7a5 5 0 1 1 1.6 3.66" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
            <path d="M2 4.2V7h2.8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
          </svg>
        </IconButton>
      )}
